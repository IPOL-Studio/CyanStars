...
==================================== 许可证 ====================================
   ...
   2. 授权内容：
      ...
      2.1 授权的文件为：在“CyanStars”仓库的“CyanStars/Cyan-Stars/Assets/CysMultimediaAssets”
          路径内（子仓库）中的文件。这些文件包括音乐作品、美术图像、Live2D 文件，但不包含源代码（源代码
   ...
   3. 使用限制
      ...
      3.2 任何使用作品的项目都不得用于盈利，但小规模商业行为以补偿支出为目的的除外。
      3.3 您只能在《CyanStars》游戏内、游戏衍生作品以及游戏宣传中使用作品，不得用于其他无关项目。
   ...
   5. 多媒体文件贡献规范
      ...
      5.2 您作为版权方，或在获取版权方的许可的情况下进行贡献。
      5.3 您确认您的贡献不会侵犯任何第三方的知识产权或其他合法权益，并承担可能由此造成的损失的后果。
      5.4 您的贡献的授权范围和针对被授权人的限制，与上文“多媒体文件使用规范”中所述相同。
