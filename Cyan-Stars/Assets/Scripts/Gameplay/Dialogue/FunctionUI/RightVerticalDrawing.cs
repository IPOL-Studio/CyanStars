...
namespace CyanStars.Dialogue
{
    public class RightVerticalDrawing : Image, ISetVerticalDrawing
    {
        ...
        public void SetAnimation(int index)
        {
            ...
            {
                case "抖动":
                    switch (DialogueManager.Instance.dialogueContentCells[index].rightVerticalDrawings.curve)
                    {
                        case "线性":
        ...
        public void SkipXAxisMovement(int index)
        {
            ...
            {
                tweener.Kill(true);
                rectTransform.anchoredPosition = new Vector2(-father_RectTransform.sizeDelta.x * DialogueManager.Instance.dialogueContentCells[index].rightVerticalDrawings.xAxisMovement, rectTransform.anchoredPosition.y);
            }
        }
        ...
        public void SetXAxisMovement(int index)
        {
            ...
            DoAnchorPosXMove(DialogueManager.Instance.dialogueContentCells[index].rightVerticalDrawings.xAxisMovement,
