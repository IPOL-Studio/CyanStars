...
namespace CyanStars.GamePlay.ChartEditor.Model
{
    ...
    public class ChartEditorModel
    {
        ...
        /// 当前选中编辑的音乐版本 item 下标
        /// </summary>
        public int? SelectedMusicVersionItemIndex { get; private set; } = null;
        ...
        /// 选中的音乐版本发生变化
        /// </summary>
        public event Action? OnSelectedMusicVersionItemChanged;
        ...
        /// <param name="chartPackData">要加载到制谱器的谱包数据</param>
        /// <param name="chartData">要加载到制谱器的谱面数据</param>
        private ChartEditorModel(string workspacePath, string chartFilePath,
                                 ChartPackData chartPackData, ChartData chartData)
        {
        ...
        public async void SetMusicVersionCanvasVisibleness(bool isVisible)
        {
            ...
            // TODO: 优化这里的卡顿
            LoadedAudioClip = (await GameRoot.Asset.LoadAssetAsync<AudioClip>(filePath)).Asset;
            OnLoadedAudioClipChanged?.Invoke();
        }
        ...
        /// 选中一个音乐版本 item
        /// </summary>
        /// <param name="index">item 下标</param>
        public void SelectMusicVersionItem(int? index)
        {
            if (SelectedMusicVersionItemIndex != index)
            {
                SelectedMusicVersionItemIndex = index;
