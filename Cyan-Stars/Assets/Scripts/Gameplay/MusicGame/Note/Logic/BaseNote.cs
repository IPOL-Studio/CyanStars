...
namespace CyanStars.Gameplay.MusicGame
{
    public abstract class BaseNote
    {
        ...
        /// 初始化数据
        /// </summary>
        public virtual void Init(BaseChartNoteData data, ChartContext context, ChartData chartData, NoteClip clip)
        {
            NoteClip = clip;
            NoteData = data;
            SpeedTemplate = context.SpeedTemplateProvider.GetSpeedTemplate(chartData.SpeedTemplateDatas[data.SpeedTemplateIndex]);
